...
export const takuroMatsui: Work = {
  ...
  summary: {
    challenge:
      "依頼検討者が作風・実績・依頼可否・連絡先を短時間で判断でき、クライアント本人も継続更新しやすいサイトにすること。",

    solution: [
      "作品一覧、作品詳細、About、Contactの役割を整理し、作風確認から問い合わせまでの導線を設計。",
      "タグ分類とMasonryレイアウトを組み合わせ、縦横比やテイストの異なる作品を比較しやすい構成にしました。",
      "microCMSで作品情報を管理できるよう項目設計を行い、クライアント本人が更新しやすい運用を想定しました。",
    ],
    ...
    task: {
      text: "要件整理、情報設計、ユーザー導線設計、Webデザイン、CMS設計、Web反映検証",
      font: "sans",
    },
  ...
  content: [
    {
      ...
      title: "サイト概要",
      titleFont: "sans",
      body: "イラストレーター Takuro Matsui 氏の作品・プロフィール・問い合わせ導線を整理したポートフォリオサイトです。依頼検討者が作風・制作実績・依頼可否・問い合わせ先を短時間で判断できる構成を目指しました。\n\n現在制作中のため一部素材は仮ですが、作品の見せ方と公開後の運用性の両立を重視しています。",
    },
    {
      type: "text",
      label: "Problem",
      title: "課題",
      titleFont: "sans",
      body: "作品の世界観を強く見せる一方で、依頼検討者が必要な情報にたどり着きにくくなるリスクがありました。また、作品追加のたびに制作者側で更新が必要になると、公開後の運用負荷が高くなります。\n\nそのため、閲覧者にとって分かりやすく、クライアント本人が継続的に更新しやすい構成が必要でした。",
    },
    {
      type: "text",
      label: "Planning",
      title: "要件整理とユーザー導線",
      titleFont: "sans",
      body: "ヒアリング内容をもとに、優先して見せたい作品、本人が更新できる運用性、人物像を伝えるAboutページを要件として整理しました。\n\n導線は、作品一覧で作風を比較し、作品詳細で実績や作品情報を確認し、Aboutで人物像を補足したうえで、Contact導線から問い合わせへ進む流れを想定しています。",
    },
    {
      type: "image",
    ...
    },
    {
      ...
      title: "今後の改善",
      titleFont: "sans",
      body: "今後は、仮素材の差し替えに加え、Aboutページで伝える制作姿勢、依頼可能な内容、Contact導線の分かりやすさを改善していく予定です。\n\n公開後は、作品一覧から作品詳細への遷移や、問い合わせ前に必要な情報へ迷わず到達できているかを確認します。また、クライアント本人にCMSを触ってもらい、作品追加の手順や入力項目の分かりやすさを検証します。",
    },
    {
      type: "text",
      label: "Reflection",
      title: "振り返り",
      titleFont: "sans",
      body: "この制作では、作品を魅力的に見せることと、依頼検討者が判断しやすい情報設計を両立する難しさを学びました。\n\n作品を主役にするために情報量を抑えながらも、依頼判断に必要な実績・人物像・問い合わせ情報は不足させないバランスが重要だと感じました。また、CMS設計では、クライアント本人が継続的に使えるかどうかを基準に項目を整理する必要があると学びました。",
    },
  ],
};
