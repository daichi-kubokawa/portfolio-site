...
export const hiketane: Work = {
  ...
  summary: {
    ...
    role: {
      text: "課題定義、ユーザーリサーチ、ユーザーテスト、体験設計、UI設計、プロトタイプ制作",
      font: "sans",
    },
    ...
    task: {
      text: "ユーザーリサーチ、ユーザーテスト、課題整理、体験設計、UIデザイン、プロトタイプ制作、企画書作成",
      font: "sans",
    },
  ...
  content: [
    {
      ...
      title: "サービス概要",
      titleFont: "sans",
      body: "ヒケタネは、過去に楽器を弾いていたものの、現在は離れてしまった人に向けた練習支援アプリです。好きな曲をもう一度弾きたい気持ちはありながらも、今の自分でも弾けるのか分からない、何から始めればよいか分からないという再開時の不安に着目しました。\n\n曲を小さな練習単位に分解し、小さな達成と曲へのつながりを可視化することで、もう一度楽器に触れるきっかけをつくる体験を目指しました。",
    },
    {
      type: "text",
      label: "Problem",
    ...
    },
    {
      ...
      title: "MVPと検証したい指標",
      titleFont: "sans",
      body: "卒業制作のため、実際の利用データはまだありません。初期MVPでは、ユーザー価値の核である「好きな曲を小さな練習単位に分解する」「練習後に曲とのつながりを確認する」「できたことを記録して成長を実感する」の3機能に絞りました。\n\n検証指標としては、初回練習完了率、翌日再訪率、7日以内の練習回数、練習単位の完了率、成長画面到達率を想定しています。特に、練習開始のハードルを下げられているか、成長実感が次の練習につながっているかを確認したいです。",
    },
    {
      type: "text",
      label: "Reflection",
