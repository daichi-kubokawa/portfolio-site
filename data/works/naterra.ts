...
export const naterra: Work = {
  ...
  summary: {
    ...
    solution: [
      ...
      "HTML / CSS / JavaScriptで実装し、商品探索から購入完了までの一連の購買体験を確認できる形にしました。",
    ],

    role: {
      text: "コンセプト設計、ロゴ制作、UI設計、フロントエンド実装",
      font: "sans",
    },
    ...
    task: {
      text: "コンセプト設計、ロゴ制作、UIデザイン、HTML / CSS / JavaScript実装",
      font: "sans",
    },
  ...
  content: [
    ...
    },
    {
      ...
      title: "振り返り",
      titleFont: "sans",
      body: "このプロジェクトでは、ブランドの世界観を表現するだけでなく、商品探索から購入完了までの流れを一貫して設計する重要性を学びました。\n\n特にECサイトでは、カテゴリの分かりやすさ、カート投入後の状態変化、購入前の不安を減らす情報設計が体験の質に影響すると感じました。今後は、商品詳細到達率、カート投入率、チェックアウト離脱率などを見ながら改善できる設計にしていきたいです。",
    },
  ],
};
