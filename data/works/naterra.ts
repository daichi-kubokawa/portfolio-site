  ...
  content: [
    {
      ...
      title: "プロジェクト概要",
      titleFont: "sans",
      body: "Naterraは、自然素材の雑貨を扱うライフスタイルショップを想定したECサイト制作プロジェクトです。コンセプト設計からロゴデザイン、UIデザイン、フロント実装まで一貫して行い、ブランドの世界観と購入しやすさの両立を目指しました。",
    },
    {
      type: "text",
      label: "Concept",
      title: "ブランドコンセプト",
      titleFont: "sans",
      body: "キャッチコピーは「自然と、くらす。」。自然素材の温もりや心地よさを、オンライン上でも感じられるブランド体験を目指しました。ブランド名のNaterraは「Nature」と「Terra」を組み合わせた造語で、自然や地球環境を大切にしながら、暮らしに寄り添う雑貨ブランドとして設計しています。",
    },
    {
      type: "text",
      label: "Logo Design",
    ...
    },
    {
      ...
      alt: "Naterraのロゴデザイン資料",
      caption: "ロゴコンセプトと展開イメージ",
      width: 1400,
      height: 800,
    },
    {
    ...
    },
    {
      ...
      alt: "NaterraのUIデザイン画面",
      caption: "トップページと主要画面のUIデザイン",
      width: 3448,
      height: 5000,
    },
    {
