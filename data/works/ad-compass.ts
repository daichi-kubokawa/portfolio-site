...
export const adCompass: Work = {
  ...
  summary: {
    ...
    solution: [
      ...
      "工程ごとに、自分で進めることと他者に確認することを整理。",
      "相談相手・確認内容・タイミングを提示し、次の行動を判断できるプロセスガイドを設計。",
    ],
