...
export const specDrivenPrototyping: Work = {
  ...
  summary: {
    ...
    solution: [
      "ヒアリングから画面生成までを一気通貫でつなぐAIワークフロー。仕様生成11分50秒、生成工程で必要な人手操作は約30秒。",
  ...
  content: [
...

    {
      ...
      caption:
        "委譲を6回から2回へ統合：所要時間 31%削減、生成する画面は3画面から4画面へ",
      width: 2342,
      height: 1120,
    },

    {
      ...
      links: [
        {
          label: "プロトタイプを見る",
          href: "https://fax-thorn-22475153.figma.site",
        },
        {
          label: "ワークフローを見る",
