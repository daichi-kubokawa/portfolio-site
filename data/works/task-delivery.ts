...
export const taskDelivery: Work = {
  ...
  content: [
    ...
    },
    {
      ...
      title: "振り返り",
      titleFont: "sans",
      body: "この制作では、課題を「タスク管理不足」ではなく「業務の現在地が見えないことで判断が止まること」と捉え直しました。工程単位で状態・担当・期限・履歴を整理することで、部署をまたぐ業務でも次に取るべき行動を判断しやすくできると考えています。\n\n今後は営業側の視点も加え、更新操作の負荷、確認待ち時間の削減、差し戻し時の追跡しやすさを検証したいです。",
    },
  ],
};
