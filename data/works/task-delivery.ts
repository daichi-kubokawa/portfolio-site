...
export const taskDelivery: Work = {
  ...
  summary: {
    ...
    role: {
      text: "課題定義、情報設計、UI設計、プロトタイプ制作、ユーザーテスト",
      font: "sans",
    },
  ...
  content: [
    ...
    },
    {
      ...
      title: "着目した背景",
      titleFont: "sans",
      body: "部署をまたぐ定型業務では、前後の工程がどこまで進んでいるかによって次の行動が変わります。しかし進行状況が個別連絡や担当者の記憶に依存すると、確認・待機・手戻りが発生しやすく、業務全体の流れが見えにくくなります。身近にいる総務担当者から実際の業務の話を聞く機会があり、この課題をテーマに設定しました。",
    },
    {
      type: "text",
      label: "Research",
